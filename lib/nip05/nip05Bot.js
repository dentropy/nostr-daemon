...
export async function nip05bot(args, options) {
  ...
  for (const domain_name_config of config.domain_names) {
    ...
    console.log("TROUBLESHOOT_PAUL_WAS_HERE");
    console.log(update_command_nostr_dot_json);
  ...
  for (const relay in config.relays) {
    relay_list_for_event.push(["r", relay]);
  }
  console.log("PAUL_WAS_HERE_001");
